...
public:
    //input data
    sensor_msgs::JointState in_init_config;
    sensor_msgs::JointState in_goal_config;
    //output data
...
public:
    ...
    bool callback_loadObstacles(std_srvs::Empty::Request  &req, std_srvs::Empty::Response &res , hpp_config config)
    {
        /* protected region user implementation of service callback for loadObstacles on begin */
        /* protected region user implementation of service callback for loadObstacles end */
        return true;
    }
